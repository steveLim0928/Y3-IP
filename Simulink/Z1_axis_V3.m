...
n7 = linspace(l6+Ts,l7,N7);
n8 = linspace(l7+Ts,l8,N8);
n9 = linspace(l8+Ts,l9,N9);
n10 = linspace(l9+Ts,T,N10);
...
y7 = (-A(2)*cos(1/time(7)*pi*(n7-l6)) + A(2))/2;
y7 = reshape(y7, [N7,1]);
...
n = [reshape(n1, [N1,1]); reshape(n2, [N2,1]); reshape(n3, [N3,1]); reshape(n4, [N4,1]); reshape(n5, [N5,1]); reshape(n6, [N6,1]); reshape(n7, [N7,1]); reshape(n8, [N8,1]); reshape(n9, [N9,1]); reshape(n10, [N10,1])];
y(1) = [];
n(1) = [];
z1_profile = [n y];
