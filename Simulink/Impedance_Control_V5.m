...
%         end
        ...
        model = sim('Impedance_Gantry_Model_V7.slx')
...
% enorm_z_0_mid = enorm_z;
% enorm_z_0_0_5_mid = enorm_z;
enorm_z_0_1_mid = enorm_z;

% enorm_z_0 = enorm_z;
% enorm_z_0_0_5 = enorm_z;
% enorm_z_0_1 = enorm_z;
