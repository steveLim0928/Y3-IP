...
time_disturbance_y = [2.4 0.1 0.2 0.1 2.2];
time_disturbance_z = [2.3 0.1 0.2 0.1 2.3];
...
% disturbance_z = sine_disturbance(T,points,A_disturbance_z,frequency);
...
%         end
        ...
        model = sim('Impedance_Gantry_Model_V6.slx')
...
% enorm_y_0_mid = enorm_y;
% enorm_y_0_0_5_mid = enorm_y;
enorm_y_0_1_mid = enorm_y;

% enorm_y_0 = enorm_y;
% enorm_y_0_0_5 = enorm_y;
% enorm_y_0_1 = enorm_y;

enorm_gL_0_1_mid = enorm_gL;
enorm_gR_0_1_mid = enorm_gR;
enorm_FgL_0_1_mid = enorm_FgL;
enorm_FgR_0_1_mid = enorm_FgR;

% enorm_gL_0 = enorm_gL;
% enorm_gR_0 = enorm_gR;
% enorm_FgL_0 = enorm_FgL;
% enorm_FgR_0 = enorm_FgR;
